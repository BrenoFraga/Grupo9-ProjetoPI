...
//    List<Contactor> contactorCompanies = new ArrayList<>();
//    List<UserContactorPerson> contactorPersons = new ArrayList<>();
//    List<RegisterProjectContactor> registerProjectContactors = new ArrayList<>();
//    List<RegisterSpecialtyUser> specialties = new ArrayList<>();
...
//    public String addUserContactorCompany(Contactor userContactorCompany){
...
//    public String addProjectCompany(RegisterProjectContactor project, String email, String password){
...
//                registerProjectContactors.add(project);
//                registerProjectContactors.get(i).setStatusProject(true);
//                companyExists = true;
...
//    public String addProjectContactorPerson(RegisterProjectContactor project, String email, String password){
...
//    }
//
//    //Adicionando RegisterSpecialtyUser
//    public String addSpecialty(RegisterSpecialtyUser specialty, String email, String password){
...
//        for (int i = 0; i < registerProjectContactors.size(); i++) {
//            if(registerProjectContactors.get(i).getNameProject().equals(nameProject) && freelancers.get(i).getEmail().equals(email) &&
//                    freelancers.get(i).getPassword().equals(password)){
//                registerProjectContactors.get(i).getProfissionals().add(freelancers.get(i));
//                projectExists = true;
//            }
//        }
//        if(projectExists){
...
//    }
//
//    //Removendo RegisterProjectContactor
//    public String deleteProject(String nameProject, String email, String password){
//        String projectName = "";
//        Boolean projectExists = false;
//        for (int i = 0; i < registerProjectContactors.size(); i++) {
//            if(registerProjectContactors.get(i).getNameProject().equals(nameProject) && contactorCompanies.get(i).getEmail().equals(email) &&
//                    contactorCompanies.get(i).getPassword().equals(password)){
//                projectName = registerProjectContactors.get(i).getNameProject();
//                projectExists = true;
//                registerProjectContactors.remove(i);
...
//        String[] historicoUser = new String[registerProjectContactors.size()];
//        Boolean userExists = false;
//        for (int i = 0; i < registerProjectContactors.size(); i++) {
//            if(registerProjectContactors.get(i).getProfissionals().contains(nomeUser)){
//                userExists = true;
//                if(userExists){
//                    for (RegisterProjectContactor p:registerProjectContactors) {
//                        if(p.getProfissionals().contains(nomeUser)){
//                            nomeProjetoUser = registerProjectContactors.get(i).getNameProject();
